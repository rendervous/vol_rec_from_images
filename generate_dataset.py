...
camera_poses = _tools.generate_camera_poses(CAMERAS, (environment_tensor > 3.14159 * 2).float() * (1.0 if BAN_EMITTERS else 0.0))
...
}, f"./datasets/{'blur_' if BLURRED else ''}{DATASET}_dataset{'' if BAN_EMITTERS else '_full'}.pt")
